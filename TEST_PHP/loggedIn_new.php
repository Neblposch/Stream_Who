...
$displayName = isset($user['display_name']) ? $user['display_name'] : 'Unbekannt';
$userId      = isset($user['id']) ? $user['id'] : 'Unbekannt';
$email       = isset($user['email']) ? $user['email'] : 'Keine E-Mail verfügbar (Scope user-read-email?)';
$images      = isset($user['images']) ? $user['images'] : array();
 ...
 * @return array|null
 */
function getSpotifyCurrentUser($accessToken)
{
