...
// Minimal Spotify PKCE helper for v1 folder
// Assumptions:
// - You have a Spotify App with redirect URI set to the callback below.
// - This file does not contain any client secret (PKCE flow only).

const SPOTIFY_CLIENT_ID = '76cdb795f3bf44b99361f82a0c16f9d0';
const SPOTIFY_REDIRECT_URI = 'http://127.0.0.1:8080/streamWho/Stream_Who/v1/callback_impl2.php';
